    ...
    $.widget('ui.weekCalendar', (function () {
            ...
            return {
                ...
                _create: function () {
                    ...
                    $(window).on('resize.weekcalendarBreakpoints', $.proxy(self.resize, self));
                },
                ...
                _resizeCalendar: function () {
                    var options = this.options;
                    if (options && ($.isFunction(options.height) || options.height === 'auto')) {
                ...
                _renderCalendarBodyEvents: function ($calendarTableTbody) {
                    ...
                    for (var i = start; i < end; i++) {
                        ...
                        if (options.use24Hour) {
                            renderRow += '<div class=\"wc-time-header-cell\"><div class=\"wc-time-header-cell-content\">' + self._24HourForIndex(i) + '</div></div>';
                        } else {
                            renderRow += '<div class=\"wc-time-header-cell\"><div class=\"wc-time-header-cell-content\">' + self._hourForIndex(i) + '<span class=\"wc-am-pm\">' + self._amOrPm(i) + '</span></div></div>';
                        }
                        renderRow += '</div>';
                    }
                    renderRow += '</td>';
